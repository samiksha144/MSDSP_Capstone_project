...
<div class="overlay-left">
  ...
  <ul>
    <li>Title page with SOP No, Area, Department, Effective date and Review date</li>
    ...
    <li>Materials, equipment & safety precautions</li>
  ...
  <ul>
    ...
    <li>Access to a pro template</li>
    <li>SOP export (Word)</li>
    <li>Audit-ready exports (zip/csv)</li>
  </ul>
</div>
""", unsafe_allow_html=True)
